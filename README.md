...
| **FlowFuel** 🏆 | Personalized nutrition + cycle tracking app — reverse-engineered Purdue Dining's menus, real-time AI meal recs | React, Node.js, Flask, Groq, RapidAPI | 🔗 [FlowFuel on Devpost][(https://devpost.com/software/flowfuel)], 🔗 [FlowFuel Repo][(https://github.com/Ys876/Fuelflow.git)]
